...
urlpatterns = [
    ...
    path('execute/', event_import_execute, name='event_import_execute'),
    ...
    path('delete-batch/<int:batch_id>/', event_import_delete_batch, name='event_import_delete_batch'),
